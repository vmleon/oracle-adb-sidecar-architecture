...
| [known-limitation-pg-link-gateway.md](known-limitation-pg-link-gateway.md) | `RUN_TEAM` reliability: the gateway idle drop, the return-path failure that still delivers an answer, and the explanations tried and abandoned. |
