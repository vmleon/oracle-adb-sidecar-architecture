...
import dev.victormartin.aidatagateway.back.measurement.MeasurementRecorder;
import dev.victormartin.aidatagateway.back.measurement.QueryMeasurement;
import dev.victormartin.aidatagateway.back.query.QueryExecutor;
import dev.victormartin.aidatagateway.back.query.QueryResult;
    ...
    public ResponseEntity<Map<String, Object>> query(
        ...
        if ("support_tickets".equals(table) && "federated".equals(route)) {
            Map<String, Object> body = Map.of("error",
                    "Not available via the AI Data Gateway — see docs/ISSUE_ADB_HETEROGENEOUS_MONGODB_OBJECT_NOT_FOUND.md");
